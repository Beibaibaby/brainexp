...
ts_transformed=np.load('/Users/dragon/Desktop/brainexp/non_tem/pcseries.npy')
pc1 = ts_transformed
...
pos_ts_gradient=np.load('/Users/dragon/Desktop/brainexp/non_tem/pos_ts_gradient.npy')
neg_ts_gradient=np.load('/Users/dragon/Desktop/brainexp/non_tem/neg_ts_gradient.npy')
pos_ts=np.load('/Users/dragon/Desktop/brainexp/non_tem/pos_ts.npy')
neg_ts=np.load('/Users/dragon/Desktop/brainexp/non_tem/neg_ts.npy')
...
if stand == True:
    ...
    pos_ts = np.interp(pos_ts, (pos_ts.min(), pos_ts.max()), (pc1.min(), pc1.max()))
    neg_ts = np.interp(neg_ts, (neg_ts.min(), neg_ts.max()), (pc1.min(), pc1.max()))
