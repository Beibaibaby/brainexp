...
view_2=np.asarray(view_2)
view_2=view_2.reshape(1000,view_2[0].size)
from sklearn.utils import shuffle
x_train, view_2 = shuffle(x_train, view_2, random_state=0)

x_train, x_test, y_train, y_test = sklearn.model_selection.train_test_split(x_train, view_2, test_size=0.1)
x_train = np.interp(x_train, (x_train.min(), x_train.max()), (0, +1))
np.save('brain_train',x_train)
np.save('brain_test',x_test)
np.save('view2_train',y_train)
np.save('view2_test',y_test)
print('check')
print(y_train[0])
