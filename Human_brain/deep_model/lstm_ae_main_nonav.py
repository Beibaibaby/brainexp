...
all_subject_fmri_features=np.load('../nonav_fmri_features.npy')
all_subject_ecg_features=np.load('../all_subject_ecg_features.npy')


all_subject_fmri_features=all_subject_fmri_features[:,:,50:60,50:60,50:55]
...
model2.compile(optimizer='adam',
              loss=tf.keras.losses.MeanSquaredError(),
              metrics=['mse'],callbacks=[tensorboard_callback])
