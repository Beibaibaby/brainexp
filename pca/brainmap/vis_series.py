...
abss = np.load('/Users/dragon/Desktop/brainexp/pca/series/overall/pca.npy')
for i in range(5):
    #abb = abss[i]
    abb=np.zeros(23)
    abb[[4, 5, 10, 11, 12, 13, 15, 16, 17, 19, 20, 21, 22]]=1
    abb[[0, 1, 2, 3, 6, 7, 8, 9, 14, 18]]=-1
    print(abb)
    ...
    plt.imshow(-mcopy, cmap='jet', aspect='auto')
    plt.colorbar()
    plt.title('Overall PC' + str(i+1) )

    plt.savefig('./overall/in_fig' + str(i))
    plt.show()